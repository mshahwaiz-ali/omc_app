...
ACTIVE_STAFF_ROLES = {ADMIN_ROLE, MANAGER_ROLE, SUPPORT_AGENT_ROLE, DOCUMENT_REVIEWER_ROLE, FINANCE_REVIEWER_ROLE, CONSULTANT_ROLE, TAX_ASSOCIATE_ROLE, BUSINESS_PARTNER_ROLE, EMPLOYEE_ROLE}
