...
void main() {
  test('approved customer More excludes persistent bottom-nav destinations', () {
  ...
  test('finance More exposes finance work without unrelated management areas', () {
  ...
  test('internal Quick Actions contain executable work instead of menu clones', () {
  ...
  test('approved customer Quick Actions omit Requests navigation duplicate', () {
    const customer = AuthCapabilities(
      accessState: AccountAccessState.approved,
    ...
    expect(labels, containsAll(['Apply', 'Documents', 'Payments', 'Support']));
