...
final serviceDetailProvider = FutureProvider.autoDispose
    .family<List<ServiceItem>, String>((ref, id) async {
      return [
        await ref.watch(serviceCatalogueRepositoryProvider).fetchDetail(id),
      ];
    });
final serviceRequestTemplateProvider = FutureProvider.autoDispose
    .family<List<ServiceItem>, String>((ref, id) async {
      return [
        await ref
            .watch(serviceCatalogueRepositoryProvider)
...
final serviceCataloguePageProvider = FutureProvider.autoDispose
    .family<
      ...
      ({int start, String search, String category})
    >((ref, query) {
      return ref
          .watch(serviceCatalogueRepositoryProvider)
          .fetchPage(
